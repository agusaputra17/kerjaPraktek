    ...
    <div class="container-fluid">
        <div class="card mt-2">
            <div class="card-header pb-2 mb-0">
                <h4 class="card-title fw-semibold" style="color: grey">BUKU REGISTER / <span class="text-success">EDIT DATA</span></h4>
            </div>
                ...
                <form method="POST" action="{{ url('books/'.$idregister) }}">
                    ...
                    <div class="row g-3">
                        <div class="col-6">
                                ...
                                <input type="text" class="form-control" id="idregister" name="idregister" value="{{ $idregister }}" disabled>
                        </div>
                        <div class="col-6">
                            <label for="txttingkat" class="col-form-label">Tingkat penanganan perkara</label>
                            <input type="text" class="form-control @error('txttingkat') is-invalid @enderror" id="txttingkat" name="txttingkat" value="{{ $txttingkat }}" >
                            @error('txttingkat')
                        ...
                        <div class="col-6">
                            ...
                            <input type="text" class="form-control @error('txttingkat') is-invalid @enderror" id="noreg" name="noreg" value="{{ $noreg }}" >
                            @error('noreg')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-6">
                            ...
                            <input type="text" class="form-control" id="pemohon" name="pemohon" value="{{ $pemohon }}" >
                        </div>
                        <div class="col-6">
                            <label for="termohon" class="col-form-label">Termohon/Tergugat</label>
                            <input type="text" class="form-control" id="termohon" name="termohon" value="{{ $termohon }}" >
                        </div>
                        <div class="col-6">
                            <label for="masalah" class="col-form-label">Masalah</label>
                            <input type="text" class="form-control" id="masalah" name="masalah" value="{{ $masalah }}" >
                        </div>
                        <div class="col-6">
                            <label for="posisi" class="col-form-label">Kasus posisi</label>
                            <input type="text" class="form-control" id="posisi" name="posisi" value="{{ $posisi }}" >
                        </div>
                        <div class="col-6">
                            <label for="tuntutan" class="col-form-label">Tuntutan penggugat/pemohon</label>
                            <input type="text" class="form-control" id="tuntutan" name="tuntutan" value="{{ $tuntutan }}" >
                        </div>
                        <div class="col-6">
                            <label for="jpn" class="col-form-label">JPN</label>
                            <input type="text" class="form-control" id="jpn" name="jpn" value="{{ $jpn }}" >
                        </div>
                        <div class="col-6">
                            <label for="tahap" class="col-form-label">Tahap & kegiatan penanganan perkara</label>
                            <input type="text" class="form-control" id="tahap" name="tahap" value="{{ $tahap }}" >
                        </div>
                        <div class="col-6">
                            <label for="hasildiluar" class="col-form-label">Hasil kegiatan di luar pengadilan</label>
                            <input type="text" class="form-control" id="hasildiluar" name="hasildiluar" value="{{ $hasildiluar }}" >
                        </div>
                        <div class="col-6">
                            <label for="hasilpenetapan" class="col-form-label">Hasil kegiatan penetapan pengadilan</label>
                            <input type="text" class="form-control" id="hasilpenetapan" name="hasilpenetapan" value="{{ $hasilpenetapan }}" >
                        </div>
                        <div class="col-6">
